...
UPDATE `vaucher_types` SET `id_class_type` = '0000000002' WHERE `vaucher_types`.`id` = 0000000001; UPDATE `vaucher_types` SET `id_class_type` = '0000000003' WHERE `vaucher_types`.`id` = 0000000002; UPDATE `vaucher_types` SET `id_class_type` = '0000000001' WHERE `vaucher_types`.`id` = 0000000003;
