...
<p>Ein, von Hand geschriebener, Gutschein wird per Post an die Lieferadresse gesendet.
...
Die beschenkte Person kann mit dem Gutschein einen beliebigen Kurs aus der geschenkten Kategorie (Pflanzenexkursion; Pflanzenwerkstatt oder Pflanzenspaziergang) besuchen.
        ...
        <div class="col-lg-auto mb-3 h-100">
            <div class="card card-body">
                <img class="img-fluid mx-auto" src="<?php echo $this->router->get_asset_path( "/img/vaucher_400x400.jpg" ); ?>" alt="Giovina Nicolai" width="250px">
            </div>
        </div>
    </div>
