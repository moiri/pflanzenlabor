    ...
    <div class="card mt-3">
        <div class="card-body">
            <dl class="row mb-0">
                ...
                <dt class="col-md-3 col-lg-2">Bankangaben</dt>
                <dd class="col-md-9 col-lg-10">
                    <p class="mb-0">Alternative Bank Schweiz AG,46 Olten 1 Fächer</br>IBAN: CH08 0839 0036 2845 1000 5</br>Konto Nr: 46-110-7</p>
                </dd>
            </dl>
        </div>
    </div>
