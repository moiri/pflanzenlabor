    ...
    <div class="col-12 col-lg-7 pr-lg-1 d-flex">
        <a href="<?php echo $this->router->generate("class", array('id' => $this->id)); ?>" class="list-group-item text-dark invert-link-img w-100">
            <div class="d-flex flex-column flex-sm-row">
                <div><img class="align-self-center mr-3" src="<?php echo $this->router->get_asset_path("/img/" . $this->img); ?>" alt="Bild zum Kurs <?php echo $this->name; ?>" height="150" width="150"></div>
                <div>
